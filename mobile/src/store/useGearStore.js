...
const useGearStore = create((set) => ({
  ...
  setResult: ({ toothCount, confidence, gearContour }) =>
    set({ toothCount, confidence, gearContour, isProcessing: false, error: null }),

  setError: (message) =>
    set({ error: message, isProcessing: false }),

  reset: () =>
    set({ toothCount: null, confidence: null, gearContour: null, isProcessing: false, error: null }),
}));
